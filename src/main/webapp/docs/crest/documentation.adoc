...
To identify `Params` as an "option aware" parameter just decorate it with `@Options`:

[source]
----
@Options
public class Params { // getters omitted for brevity
    private final int r;
    private final int g;
    private final int b;
    private final int a;

    public Params(@Option("r") @Default("255") final int r,
