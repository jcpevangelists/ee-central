...
You may specify `javaeeio_config_root` maven property to point to an alternative github repository. 
...
In order to preview your local html pages, you may use `javaeeio_devel_pages_root` maven property to point to a folder on you disk. 
